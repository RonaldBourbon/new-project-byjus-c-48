...
balloonFloor = createSprite(0,420,20,10);
balloonFloor.x = balloon.x;
balloonFloor.debug = true;

balloonTop = createSprite(0,-20,20,10);
balloonTop.x = balloon.x;
balloonTop.debug = true;
...
function draw() {
  ...
  balloon.collide(balloonFloor);
  balloon.collide(balloonTop);
